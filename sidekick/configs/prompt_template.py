TASK_PROMPT = {
    ...
    "user_prompt": """
        ### Given an input *Question*, let's work it out in a detailed step by step way and only return specific, detailed and informative tasks as an ordered numeric list for SQL generation to be sure we have the right answer.
        ...
        Infer the return type of the Question. Do not generate final complete SQL response, only return itemized tasks.
